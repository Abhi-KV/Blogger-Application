...
public class CommentController {
    ...
    public ResponseEntity<String> deleteComment(@PathVariable long commentId){
        ...
        return new ResponseEntity<>("Comment is deleted having id:"+commentId,HttpStatus.OK);

    }
    @GetMapping("/{postId}")
    public ResponseEntity<List<CommentDto>> getCommentsByPostId(@PathVariable long postId,CommentDto commentDto){
